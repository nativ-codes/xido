...
const CompanyInfo = {
  [CompanyInfoSections.OVERALL]: [
    {
      title: "Weight",
      description:
        "Proportion of the company's value within the overall portfolio.",
    },
    {
      title: "Invested",
    ...
    },
    {
      title: "Profit/Loss",
      description:
        "Financial gain or loss based on the difference between invested capital and market price.",
    },
  ],
  [CompanyInfoSections.SHARES]: [
    ...
    },
    {
      ...
      description:
        "Difference between current market share price and the lowest price paid for a share.",
    },
    {
    ...
    },
    {
      ...
      description:
        "Difference between current market price and the average purchase price of shares.",
    },
    {
    ...
    },
    {
      ...
      description:
        "Difference between current market share price and the highest price paid for a share.",
    },
  ],
  [CompanyInfoSections.DIVIDENDS]: [
    {
      ...
      description:
        "Percentage return from dividends relative to the share price.",
    },
    {
    ...
    },
    {
      ...
      description:
        "Cumulative total of all dividends received from the company.",
    },
  ],
  [CompanyInfoSections.EXPECTED_DIVIDENDS]: [
    {
      ...
      description:
        "The expected dividends from the company based on the previous dividends received.",
    },
  ],
...
const CalendarInfo = [
  {
    title: "Month weight",
    description:
      "Proportion of the company's dividend relative to total monthly dividends received.",
  },
  {
    title: "Expected month weight",
    description:
      "Expected proportion of the company's dividend relative to total monthly expected dividends.",
  },
  {
...
const HomeInfo = {
  ...
  [HomeInfoSections.DIVIDENDS]: [
    ...
    },
    {
      ...
      description:
        "Average dividend yield received from all companies in the portfolio.",
    },
  ],
};

export { HomeInfo, CalendarInfo, CompanyInfo };
