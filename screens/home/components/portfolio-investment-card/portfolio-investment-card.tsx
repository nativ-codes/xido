...
function PortfolioInvestmentCard({ overall, currency, onInfoPress }: PortfolioInvestmentCardPropsType) {
	return (
		<Card>
			...
			<ListItem
				variant={overall.profitOrLoss > 0 ? ListItemVariants.PROFIT : ListItemVariants.LOSS}
