    ...
    <BottomSheet title="Help" isVisible={isVisible} onBackdropPress={hideModal}>
      <View style={styles.content}>
        <View style={styles.section}>
          ...
          <Text variant="h4">
            Make sure you logged in on your XTB account, and selected the right
            investment account.
          </Text>
        </View>
        <View style={styles.section}>
          ...
          <Text variant="h4">
            Navigate to the Account history tab, and then Cash operations
            subtab, select the date range and click APPLY.
          </Text>
          <Image
            source={CashOperations}
            resizeMode="contain"
            style={styles.image}
          />
        </View>
        <View style={styles.section}>
          ...
          <Text variant="h4">
            Select CASH OPERATIONS as REPORT TYPE and CSV as FILE FORMAT, and
            then click on EXPORT REPORT button.
          </Text>
          <Image
            source={ExportReport}
            resizeMode="contain"
